...
dicube.save(dcb_image, 'dicube-testdata/test_sequence.dcbs')

# 测试DiCube加载性能
start_time = time.time()
loaded_image = dicube.load('dicube-testdata/test_sequence.dcbs')
...
# 快速加载元数据（不含像素数据）
start_time = time.time()
meta = dicube.load_meta('dicube-testdata/test_sequence.dcbs')
...
dcb_size = os.path.getsize('dicube-testdata/test_sequence.dcbs')
...
# 清理测试文件
os.remove('dicube-testdata/test_sequence.dcbs')
```
...
dcb_concurrent_time = dcb_concurrent_test('dicube-testdata/test_sequence.dcbs')
