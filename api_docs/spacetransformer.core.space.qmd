# spacetransformer.core.space { #spacetransformer.core.space }
...
| Name | Description |
| --- | --- |
| [Space](#spacetransformer.core.space.Space) | Represents the geometric space of reference for 3D medical images. |

### Space { #spacetransformer.core.space.Space }
...
| Name | Description |
| --- | --- |
| [end](#spacetransformer.core.space.Space.end) | Get the world coordinates of the image's corner voxel. |
| [from_world_transform](#spacetransformer.core.space.Space.from_world_transform) | Get the world → index coordinate transformation (lazy-loaded). |
| [orientation_matrix](#spacetransformer.core.space.Space.orientation_matrix) | Return the 3x3 orientation matrix with direction cosines as columns. |
| [physical_span](#spacetransformer.core.space.Space.physical_span) | Get the total physical span of the image in world coordinates (mm). |
| [scaled_orientation_matrix](#spacetransformer.core.space.Space.scaled_orientation_matrix) | Return the 3x3 orientation matrix scaled by voxel spacing. |
| [shape_zyx](#spacetransformer.core.space.Space.shape_zyx) | Get the shape in ZYX order for Python indexing. |
| [to_world_transform](#spacetransformer.core.space.Space.to_world_transform) | Get the index → world coordinate transformation (lazy-loaded). |

#### Methods

| Name | Description |
| --- | --- |
| [apply_bbox](#spacetransformer.core.space.Space.apply_bbox) | Crop the space to a bounding box. |
| [apply_flip](#spacetransformer.core.space.Space.apply_flip) | Flip the space along a specified axis. |
| [apply_float_bbox](#spacetransformer.core.space.Space.apply_float_bbox) | Crop with floating-point bounding box and resample to specified shape. |
| [apply_permute](#spacetransformer.core.space.Space.apply_permute) | Rearrange axes according to the given order. |
| [apply_rotate](#spacetransformer.core.space.Space.apply_rotate) | Rotate the space around a specified axis. |
| [apply_shape](#spacetransformer.core.space.Space.apply_shape) | Create a new space with modified shape, adjusting spacing and possibly origin. |
| [apply_spacing](#spacetransformer.core.space.Space.apply_spacing) | Create a new space with modified spacing only. |
| [apply_swap](#spacetransformer.core.space.Space.apply_swap) | Swap two axes in the space. |
| [apply_zoom](#spacetransformer.core.space.Space.apply_zoom) | Scale the shape by the given factor. |
| [contain_pointset_ind](#spacetransformer.core.space.Space.contain_pointset_ind) | Check if index coordinates are within the space bounds. |
| [contain_pointset_world](#spacetransformer.core.space.Space.contain_pointset_world) | Check if world coordinates are within the space bounds. |
| [copy](#spacetransformer.core.space.Space.copy) | Return a new Space instance with identical values. |
| [from_dict](#spacetransformer.core.space.Space.from_dict) | Create a Space object from a dictionary. |
| [from_json](#spacetransformer.core.space.Space.from_json) | Create a Space object from a JSON string. |
| [from_nifti](#spacetransformer.core.space.Space.from_nifti) | Create a Space object from a NIfTI image. |
| [from_sitk](#spacetransformer.core.space.Space.from_sitk) | Create a Space object from a SimpleITK Image. |
| [reverse_axis_order](#spacetransformer.core.space.Space.reverse_axis_order) | Convert space information to ZYX order for Python indexing. |
| [to_dicom_orientation](#spacetransformer.core.space.Space.to_dicom_orientation) | Convert orientation vectors to DICOM Image Orientation (Patient) format. |
| [to_json](#spacetransformer.core.space.Space.to_json) | Serialize the Space object to a JSON string. |
| [to_nifti_affine](#spacetransformer.core.space.Space.to_nifti_affine) | Convert space information to NIfTI affine transformation matrix. |
| [to_sitk_direction](#spacetransformer.core.space.Space.to_sitk_direction) | Convert orientation vectors to SimpleITK direction matrix format. |

##### apply_bbox { #spacetransformer.core.space.Space.apply_bbox }

```python
core.space.Space.apply_bbox(bbox, include_end=False)
```
...
##### apply_flip { #spacetransformer.core.space.Space.apply_flip }

```python
core.space.Space.apply_flip(axis)
```
...
##### apply_float_bbox { #spacetransformer.core.space.Space.apply_float_bbox }

```python
core.space.Space.apply_float_bbox(bbox, shape)
```
...
##### apply_permute { #spacetransformer.core.space.Space.apply_permute }

```python
core.space.Space.apply_permute(axis_order)
```
...
##### apply_rotate { #spacetransformer.core.space.Space.apply_rotate }

```python
core.space.Space.apply_rotate(axis, angle, unit='degree', center='center')
```
...
##### apply_shape { #spacetransformer.core.space.Space.apply_shape }

```python
core.space.Space.apply_shape(shape, align_corners=True)
```
...
##### apply_spacing { #spacetransformer.core.space.Space.apply_spacing }

```python
core.space.Space.apply_spacing(spacing, recompute_spacing=True)
```
...
##### apply_swap { #spacetransformer.core.space.Space.apply_swap }

```python
core.space.Space.apply_swap(axis1, axis2)
```
...
##### apply_zoom { #spacetransformer.core.space.Space.apply_zoom }

```python
core.space.Space.apply_zoom(factor, mode='floor', align_corners=True)
```
...
##### contain_pointset_ind { #spacetransformer.core.space.Space.contain_pointset_ind }

```python
core.space.Space.contain_pointset_ind(pointset_ind)
```
...
##### contain_pointset_world { #spacetransformer.core.space.Space.contain_pointset_world }

```python
core.space.Space.contain_pointset_world(pointset_world)
```
...
##### copy { #spacetransformer.core.space.Space.copy }

```python
core.space.Space.copy()
```
...
##### from_dict { #spacetransformer.core.space.Space.from_dict }

```python
core.space.Space.from_dict(data)
```
...
##### from_json { #spacetransformer.core.space.Space.from_json }

```python
core.space.Space.from_json(json_str)
```
...
##### from_nifti { #spacetransformer.core.space.Space.from_nifti }

```python
core.space.Space.from_nifti(niftiimage)
```
...
##### from_sitk { #spacetransformer.core.space.Space.from_sitk }

```python
core.space.Space.from_sitk(simpleitkimage)
```
...
##### reverse_axis_order { #spacetransformer.core.space.Space.reverse_axis_order }

```python
core.space.Space.reverse_axis_order()
```
...
##### to_dicom_orientation { #spacetransformer.core.space.Space.to_dicom_orientation }

```python
core.space.Space.to_dicom_orientation()
```
...
##### to_json { #spacetransformer.core.space.Space.to_json }

```python
core.space.Space.to_json()
```
...
##### to_nifti_affine { #spacetransformer.core.space.Space.to_nifti_affine }

```python
core.space.Space.to_nifti_affine()
```
...
##### to_sitk_direction { #spacetransformer.core.space.Space.to_sitk_direction }

```python
core.space.Space.to_sitk_direction()
```
...
| Name | Description |
| --- | --- |
| [get_space_from_nifti](#spacetransformer.core.space.get_space_from_nifti) | Create a Space object from a NIfTI image. |
| [get_space_from_sitk](#spacetransformer.core.space.get_space_from_sitk) | Create a Space object from a SimpleITK Image. |

### get_space_from_nifti { #spacetransformer.core.space.get_space_from_nifti }

```python
core.space.get_space_from_nifti(niftiimage)
```
...
### get_space_from_sitk { #spacetransformer.core.space.get_space_from_sitk }

```python
core.space.get_space_from_sitk(simpleitkimage)
```
