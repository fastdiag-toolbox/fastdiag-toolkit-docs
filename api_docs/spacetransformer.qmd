...
| Name | Description |
| --- | --- |
| [Space](#spacetransformer.Space) | Represents the geometric space of reference for 3D medical images. |
| [Transform](#spacetransformer.Transform) | 4x4 homogeneous coordinate transformation matrix wrapper. |

### Space { #spacetransformer.Space }
...
| Name | Description |
| --- | --- |
| [end](#spacetransformer.Space.end) | Get the world coordinates of the image's corner voxel. |
| [from_world_transform](#spacetransformer.Space.from_world_transform) | Get the world → index coordinate transformation (lazy-loaded). |
| [orientation_matrix](#spacetransformer.Space.orientation_matrix) | Return the 3x3 orientation matrix with direction cosines as columns. |
| [physical_span](#spacetransformer.Space.physical_span) | Get the total physical span of the image in world coordinates (mm). |
| [scaled_orientation_matrix](#spacetransformer.Space.scaled_orientation_matrix) | Return the 3x3 orientation matrix scaled by voxel spacing. |
| [shape_zyx](#spacetransformer.Space.shape_zyx) | Get the shape in ZYX order for Python indexing. |
| [to_world_transform](#spacetransformer.Space.to_world_transform) | Get the index → world coordinate transformation (lazy-loaded). |

#### Methods

| Name | Description |
| --- | --- |
| [apply_bbox](#spacetransformer.Space.apply_bbox) | Crop the space to a bounding box. |
| [apply_flip](#spacetransformer.Space.apply_flip) | Flip the space along a specified axis. |
| [apply_float_bbox](#spacetransformer.Space.apply_float_bbox) | Crop with floating-point bounding box and resample to specified shape. |
| [apply_permute](#spacetransformer.Space.apply_permute) | Rearrange axes according to the given order. |
| [apply_rotate](#spacetransformer.Space.apply_rotate) | Rotate the space around a specified axis. |
| [apply_shape](#spacetransformer.Space.apply_shape) | Create a new space with modified shape, adjusting spacing and possibly origin. |
| [apply_spacing](#spacetransformer.Space.apply_spacing) | Create a new space with modified spacing only. |
| [apply_swap](#spacetransformer.Space.apply_swap) | Swap two axes in the space. |
| [apply_zoom](#spacetransformer.Space.apply_zoom) | Scale the shape by the given factor. |
| [contain_pointset_ind](#spacetransformer.Space.contain_pointset_ind) | Check if index coordinates are within the space bounds. |
| [contain_pointset_world](#spacetransformer.Space.contain_pointset_world) | Check if world coordinates are within the space bounds. |
| [copy](#spacetransformer.Space.copy) | Return a new Space instance with identical values. |
| [from_dict](#spacetransformer.Space.from_dict) | Create a Space object from a dictionary. |
| [from_json](#spacetransformer.Space.from_json) | Create a Space object from a JSON string. |
| [from_nifti](#spacetransformer.Space.from_nifti) | Create a Space object from a NIfTI image. |
| [from_sitk](#spacetransformer.Space.from_sitk) | Create a Space object from a SimpleITK Image. |
| [reverse_axis_order](#spacetransformer.Space.reverse_axis_order) | Convert space information to ZYX order for Python indexing. |
| [to_dicom_orientation](#spacetransformer.Space.to_dicom_orientation) | Convert orientation vectors to DICOM Image Orientation (Patient) format. |
| [to_json](#spacetransformer.Space.to_json) | Serialize the Space object to a JSON string. |
| [to_nifti_affine](#spacetransformer.Space.to_nifti_affine) | Convert space information to NIfTI affine transformation matrix. |
| [to_sitk_direction](#spacetransformer.Space.to_sitk_direction) | Convert orientation vectors to SimpleITK direction matrix format. |

##### apply_bbox { #spacetransformer.Space.apply_bbox }
...
##### apply_flip { #spacetransformer.Space.apply_flip }
...
##### apply_float_bbox { #spacetransformer.Space.apply_float_bbox }
...
##### apply_permute { #spacetransformer.Space.apply_permute }
...
##### apply_rotate { #spacetransformer.Space.apply_rotate }
...
##### apply_shape { #spacetransformer.Space.apply_shape }
...
##### apply_spacing { #spacetransformer.Space.apply_spacing }
...
##### apply_swap { #spacetransformer.Space.apply_swap }
...
##### apply_zoom { #spacetransformer.Space.apply_zoom }
...
##### contain_pointset_ind { #spacetransformer.Space.contain_pointset_ind }
...
##### contain_pointset_world { #spacetransformer.Space.contain_pointset_world }
...
##### copy { #spacetransformer.Space.copy }
...
##### from_dict { #spacetransformer.Space.from_dict }
...
##### from_json { #spacetransformer.Space.from_json }
...
##### from_nifti { #spacetransformer.Space.from_nifti }
...
##### from_sitk { #spacetransformer.Space.from_sitk }
...
##### reverse_axis_order { #spacetransformer.Space.reverse_axis_order }
...
##### to_dicom_orientation { #spacetransformer.Space.to_dicom_orientation }
...
##### to_json { #spacetransformer.Space.to_json }
...
##### to_nifti_affine { #spacetransformer.Space.to_nifti_affine }
...
##### to_sitk_direction { #spacetransformer.Space.to_sitk_direction }
...
### Transform { #spacetransformer.Transform }
...
| Name | Description |
| --- | --- |
| [apply_point](#spacetransformer.Transform.apply_point) | Apply transformation to a set of points. |
| [apply_vector](#spacetransformer.Transform.apply_vector) | Apply transformation to a set of vectors (ignoring translation). |
| [compose](#spacetransformer.Transform.compose) | Compose transformations with self applied first. |
| [inverse](#spacetransformer.Transform.inverse) | Return the inverse transformation (lazy computed and cached). |

##### apply_point { #spacetransformer.Transform.apply_point }
...
##### apply_vector { #spacetransformer.Transform.apply_vector }
...
##### compose { #spacetransformer.Transform.compose }
...
##### inverse { #spacetransformer.Transform.inverse }
...
| Name | Description |
| --- | --- |
| [calc_transform](#spacetransformer.calc_transform) | Calculate transformation matrix from source to target space. |
| [find_tight_bbox](#spacetransformer.find_tight_bbox) | Calculate the tight bounding box of source space in target index coordinates. |
| [get_space_from_nifti](#spacetransformer.get_space_from_nifti) | Create a Space object from a NIfTI image. |
| [get_space_from_sitk](#spacetransformer.get_space_from_sitk) | Create a Space object from a SimpleITK Image. |
| [warp_point](#spacetransformer.warp_point) | Transform point set from source to target space coordinates. |
| [warp_vector](#spacetransformer.warp_vector) | Transform vector set between coordinate spaces (translation-invariant). |

### calc_transform { #spacetransformer.calc_transform }
...
### find_tight_bbox { #spacetransformer.find_tight_bbox }
...
### get_space_from_nifti { #spacetransformer.get_space_from_nifti }
...
### get_space_from_sitk { #spacetransformer.get_space_from_sitk }
...
### warp_point { #spacetransformer.warp_point }
...
### warp_vector { #spacetransformer.warp_vector }
